  ...
  <svg
    ...
    <g id="glyphicons">
      <g id="thumbs-up">
        <polygon
          style={{ opacity: 0.3 }}
          points="33,25 34,24 34,22 32,22 26,31 29,31 		"
        />
        <path
          d="M26,14v3l-1,5h9v2l-1,1l-4,6h-5l-2-1h-2v-8l3-4l2-4H26 M26,12h-1c-0.757,0-1.45,0.428-1.789,1.106l-1.919,3.839L18.4,20.8
