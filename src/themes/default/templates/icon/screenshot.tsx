  ...
  <svg
    ...
    <g id="glyphicons">
      <g id="screenshot">
        <g>
          <path
            d="M24.508,31.023c-4.136,0-7.5-3.364-7.5-7.5c0-4.136,3.364-7.5,7.5-7.5c4.136,0,7.5,3.364,7.5,7.5
        ...
        <g>
          <path
            d="M14,24h-2.5c-0.275,0-0.5-0.225-0.5-0.5s0.225-0.5,0.5-0.5H14h3.025h1H23v1h-4.975h-1H14z M24,17.025V22h1v-4.975v-1V14
        ...
        <g style={{ opacity: 0.3 }}>
          <path
            d="M30.975,24H26v-1h4.975h0.007c-0.255-3.177-2.801-5.711-5.981-5.951V22h-1v-4.951c-3.174,0.248-5.711,2.779-5.966,5.951
